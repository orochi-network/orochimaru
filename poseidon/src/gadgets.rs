...
/// A duplex sponge for the Poseidon permutation.
#[derive(Debug)]
pub struct Sponge<
    F: PrimeField,
    S: Spec<F, T, R>,
...
#[derive(Clone, Debug)]
/// A stateword from the state of a Poseidon sponge.
